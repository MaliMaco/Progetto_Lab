...
html_path = os.path.join(os.path.dirname(__file__), "html_tand_endpoint.txt")
...
async def main():
    ...
    async with AsyncWebCrawler(config=browser_config) as crawler:
        result = await crawler.arun(
            url="https://www.tandfonline.com/doi/full/10.1080/01691864.2026.2642632#graphical-abstract",
            config=run_config
        )
