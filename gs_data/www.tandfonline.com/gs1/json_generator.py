...
html_file = open(os.path.join(os.path.dirname(__file__),"html_tand_methods.txt"), "r", encoding="UTF-8")
...
match = re.search(pattern_domain, "https://www.tandfonline.com/doi/full/10.1080/00014788.2026.2625716#d1e157")
domain = match.group(1)


json_entry = {
    "url": "https://www.tandfonline.com/doi/full/10.1080/00014788.2026.2625716#d1e157",
    "domain": domain,
    "title": title,
    "html_text":  html_text,
    "gold_text": gs_text
