...
html_file = open(os.path.join(os.path.dirname(__file__),"html_apple_notion.txt"), "r", encoding="UTF-8")
...
url_list = "https://apps.apple.com/us/iphone/search?term=notion".split("/")
domain = url_list[2]

json_entry = {
    "url": "https://apps.apple.com/us/iphone/search?term=notion",
    "domain": domain,
    "title": title,
    "html_text":  html_text,
    "gold_text": gs_text
