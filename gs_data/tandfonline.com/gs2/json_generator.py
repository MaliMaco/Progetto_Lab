...
html_file = open(os.path.join(os.path.dirname(__file__),"html_tand_facilitating.txt"), "r", encoding="UTF-8")
...
match = re.search(pattern_domain, "https://www.tandfonline.com/doi/full/10.1080/18387357.2026.2661084#abstract")
domain = match.group(1)


json_entry = {
    "url": "https://www.tandfonline.com/doi/full/10.1080/18387357.2026.2661084#abstract",
    "domain": domain,
    "title": title,
    "html_text":  html_text,
    "gold_text": gs_text
