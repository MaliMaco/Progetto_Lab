...
html_file = open(os.path.join(os.path.dirname(__file__),"html_apple_clash.txt"), "r", encoding="UTF-8")
...
url_list = "https://apps.apple.com/us/app/clash-royale/id1053012308".split("/")
domain = url_list[2]
