...
html_file = open(os.path.join(os.path.dirname(__file__),"gs4.html"), "r", encoding="UTF-8")
...
match = re.search(pattern_domain, "https://www.ecb.europa.eu/mopo/implement/omo/html/index.en.html")
