...
html_file = open(os.path.join(os.path.dirname(__file__),"html_apple_pubg.txt"), "r", encoding="UTF-8")
...
url_list = "https://apps.apple.com/us/app/pubg-mobile/id1330123889".split("/")
domain = url_list[2]

json_entry = {
    "url": "https://apps.apple.com/us/app/pubg-mobile/id1330123889",
    "domain": domain,
    "title": title,
    "html_text":  html_text,
    "gold_text": gs_text
