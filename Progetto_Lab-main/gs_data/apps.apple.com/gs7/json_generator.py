...
html_file = open(os.path.join(os.path.dirname(__file__),"html_apple_calendar.txt"), "r", encoding="UTF-8")
...
url_list = "https://apps.apple.com/us/app/google-calendar-get-organized/id909319292".split("/")
domain = url_list[2]
