...
html_file = open(os.path.join(os.path.dirname(__file__),"html_tand_board.txt"), "r", encoding="UTF-8")
...
match = re.search(pattern_domain, "https://www.tandfonline.com/doi/full/10.1080/17449480.2026.2622079#abstract")
domain = match.group(1)


json_entry = {
    "url": "https://www.tandfonline.com/doi/full/10.1080/17449480.2026.2622079#abstract",
    "domain": domain,
    "title": title,
    "html_text":  html_text,
    "gold_text": gs_text
