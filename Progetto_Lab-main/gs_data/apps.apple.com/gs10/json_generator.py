...
html_file = open(os.path.join(os.path.dirname(__file__),"html_apple_prime.txt"), "r", encoding="UTF-8")
...
url_list = "https://apps.apple.com/us/app/amazon-prime-video/id545519333".split("/")
domain = url_list[2]
