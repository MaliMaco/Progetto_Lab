...
html_file = open(os.path.join(os.path.dirname(__file__),"html_tand_attention.txt"), "r", encoding="UTF-8")
...
url_split = "https://www.tandfonline.com/doi/full/10.1080/13825585.2026.2642770#inline_frontnotes".split("/")
domain = url_split[2]


json_entry = {
    "url": "https://www.tandfonline.com/doi/full/10.1080/13825585.2026.2642770#inline_frontnotes",
    "domain": domain,
    "title": title,
    "html_text":  html_text,
    "gold_text": gs_text
...
result = open(os.path.join(os.path.dirname(__file__),"gs10.json"), "w", encoding="UTF-8")
