...
html_file = open(os.path.join(os.path.dirname(__file__),"gs5.html"), "r", encoding="UTF-8")
...
match = re.search(pattern_domain, "https://www.ecb.europa.eu/paym/cyber-resilience/fmi/html/index.en.html")
