...
sito1_json = open("./EBC/gs1/gs1.json", "r", encoding="UTF-8")
sito2_json = open("./EBC/gs2/gs2.json", "r", encoding="UTF-8")
sito3_json = open("./EBC/gs3/gs3.json", "r", encoding="UTF-8")
sito4_json = open("./EBC/gs4/gs4.json", "r", encoding="UTF-8")
sito5_json = open("./EBC/gs5/gs5.json", "r", encoding="UTF-8")
...
GS_json = open("./ECB/GS.json", "w", encoding="UTF-8")
