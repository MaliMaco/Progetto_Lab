...
html_file = open(os.path.join(os.path.dirname(__file__),"html_ecb_med.txt"), "r", encoding="UTF-8")
...
match = re.search(pattern_domain, "https://www.ecb.europa.eu/mopo/strategy/medium-term-orientation/html/index.it.html")
domain = match.group(1)


json_entry = {
    "url": "https://www.ecb.europa.eu/mopo/strategy/medium-term-orientation/html/index.it.html",
    "domain": domain,
    "title": title,
    "html_text":  html_text,
    "gold_text": gs_text
